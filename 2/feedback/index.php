...
$form['form-main'] = array(
	...
	'cfg' => array(
		...
		'from_name' => 'Новая заявка',
		'to_email' => 'slabitskiy.igor@yandex.ua',
		...
		'okay' => 'Спасибо, что обратились в нашу компанию! <br/> Наш менеджер свяжется с Вами <br/> в ближайшее время. ',
		'fuck' => 'Заявка не отправлена, это наверное у нас проблемы, позвоните к нам : +7 499 686 05 96 ',
		'spam' => 'Cпам робот',
