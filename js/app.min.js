...
function inArray(e,t){for(var n=t.length,a=0;n>a;a++)if("object"==typeof t[a]){if(arrayCompare(t[a],e))return!0}else if(t[a]==e)return!0;return!1}function myconf(){var e=$.Deferred();return $.ajax({type:"POST",url:"feedback/",dataType:"json",data:"act=cfg",success:function(t){e.resolve(t.configs)}}),e}window.isset=function(e){if("object"==typeof e&&"undefined"==e)return!1;if(0===arguments.length)return!1;for(var t=arguments[0],n=0;n<arguments.length;n++){if("undefined"==typeof t||null===t)return!1;t=t[arguments[n+1]]}return!0};var mcf=myconf();mcf.done(function(e){function t(t){var n=$(t.form).find(".feedback"),a=(n.clone(),n.val(),e[t.act].cfg);$.ajax({type:"POST",url:"feedback/",cache:!1,dataType:"json",data:"act="+t.act+"&"+t.data,beforeSend:function(){$(n).prop("disabled",!0),$(n).addClass("loading")},success:function(e){if(isset(a.notify)&&!/none/i.test(a.notify)&&/color/i.test(a.notify)&&(isset(e.errors)&&$.each(e.errors,function(e,n){var a=/[a-z]/i;if(a.test(e)){var o=$(t.form).find("[name="+e+"]");1==o.length}}),isset(e.infos))){var o="",s=$("<ul>",{id:"feedback-infolist"});$.each(e.infos,function(e,t){o+="<li>"+t+"</li>"}),s.html(o),/modal/i.test(a.notify)&&($(".form-contact").find(".active").removeClass("active"),$(".feedback").addClass("true"),setTimeout(function(){$(".form-main").removeClass("fadeIn"),setTimeout(function(){$(".contact-from").removeClass("active"),$("body,html").removeClass("stop-scroll")},350)},1500))}$(n).prop("disabled",!1),$(n).removeClass("loading"),isset(e.ok)&&1==e.ok&&$(t.form)[0].reset()}})}$(document).ready(function(){!function(){var t=$(".feedback");t.length>0&&t.each(function(){var t=$(this).closest("form"),n=t.attr("name");isset(e[n])&&isset(e[n].cfg.antispamjs)&&$(t).prepend('<input type="text" name="'+e[n].cfg.antispamjs+'" value="tesby" style="display:none;">')})}()}),$(document).on("mouseenter mouseover",".feedback",function(){var t=$(this).closest("form"),n=t.attr("name");isset(e[n])&&isset(e[n].cfg.antispamjs)&&$("input[name="+e[n].cfg.antispamjs+"]").val("")}),$(document).on("click",".feedback",function(){var e=$(this).closest("form"),n=e.attr("name"),a={};return a.form=e,a.act=n,a.data=$(e).serialize(),t(a),!1})});
console.log("hey there! nice to meet you! "),console.log("─────────────────────────────────────\n──────█▀▄─▄▀▄─▀█▀─█─█─▀─█▀▄─▄▀▀▀─────\n──────█─█─█─█──█──█▀█─█─█─█─█─▀█─────\n──────▀─▀──▀───▀──▀─▀─▀─▀─▀──▀▀──────\n─────────────────────────────────────\n───────────────▀█▀─▄▀▄───────────────\n────────────────█──█─█───────────────\n────────────────▀───▀────────────────\n─────────────────────────────────────\n─────█▀▀▄─█▀▀█───█──█─█▀▀─█▀▀█─█▀▀───\n─────█──█─█──█───█▀▀█─█▀▀─█▄▄▀─█▀▀───\n─────▀▀▀──▀▀▀▀───▀──▀─▀▀▀─▀─▀▀─▀▀▀───\n─────────────────────────────────────\n─────────▄███████████▄▄──────────────\n──────▄██▀──────────▀▀██▄────────────\n────▄█▀────────────────▀██───────────\n──▄█▀────────────────────▀█▄─────────\n─█▀──██──────────────██───▀██────────\n█▀──────────────────────────██───────\n█──███████████████████───────█───────\n█────────────────────────────█───────\n█────────────────────────────█───────\n█────────────────────────────█───────\n█────────────────────────────█───────\n█────────────────────────────█───────\n█▄───────────────────────────█───────\n▀█▄─────────────────────────██───────\n─▀█▄───────────────────────██────────\n──▀█▄────────────────────▄█▀─────────\n───▀█▄──────────────────██───────────\n─────▀█▄──────────────▄█▀────────────\n───────▀█▄▄▄──────▄▄▄███████▄▄───────\n────────███████████████───▀██████▄───\n─────▄███▀▀────────▀███▄──────█─███──\n───▄███▄─────▄▄▄▄────███────▄▄████▀──\n─▄███▓▓█─────█▓▓█───████████████▀────\n─▀▀██▀▀▀▀▀▀▀▀▀▀███████████────█──────\n────█─▄▄▄▄▄▄▄▄█▀█▓▓─────██────█──────\n────█─█───────█─█─▓▓────██────█──────\n────█▄█───────█▄█──▓▓▓▓▓███▄▄▄█──────\n────────────────────────██──────────\n────────────────────────██───▄███▄───\n────────────────────────██─▄██▓▓▓██──\n───────────────▄██████████─█▓▓▓█▓▓██▄\n─────────────▄██▀───▀▀███──█▓▓▓██▓▓▓█\n─▄███████▄──███───▄▄████───██▓▓████▓█\n▄██▀──▀▀█████████████▀▀─────██▓▓▓▓███\n██▀─────────██──────────────██▓██▓███\n██──────────███──────────────█████─██\n██───────────███──────────────█─██──█\n██────────────██─────────────────█───\n██─────────────██────────────────────\n██─────────────███───────────────────\n██──────────────███▄▄────────────────\n███──────────────▀▀███───────────────\n─███─────────────────────────────────\n──███───────────────────────────────\n"),$(window).load(function(){function n(){function n(){$("#title").typed({strings:["Hi! I'm Igor Slabitskiy"],typeSpeed:75,callback:function(){$("#title").next().fadeOut(200),$("#subtitle-text").typed({strings:["Frontend Developer - from Ukraine"],typeSpeed:35,callback:function(){$("#subtitle-text").next().fadeOut(200),setTimeout(function(){$(".button-contact").addClass("fadeIn"),setTimeout(function(){$(".button-portfolio").addClass("fadeIn"),setTimeout(function(){$("body,html").removeClass("stop-scroll")},750)},750)},100)}})}})}var i=o.toFixed(1)<=1?1:o-=.4,s=a>=90?100:a+=15,c=$(".header-content").innerHeight()+$(".loader-center").innerHeight();if(e.css({animationDuration:i+"s",borderRadius:s+"px"}),1==i){if(e.hasClass("to-circle"))return!1;e.addClass("to-circle"),t.addClass("animate"),t.find(".loader-center").css({marginTop:"-"+(c+40)+"px"}),setTimeout(function(){n()},500)}}{var t=$(".loader"),e=t.find(".loader-border"),o=4,a=0;$(".fadeInButton")}setInterval(function(){n()},450)}),$(document).ready(function(){function n(){$(".header-content").css({marginTop:$(window).innerHeight()/2-e+55})}function t(n){$("html, body").animate({scrollTop:$(n).offset().top},800)}var e=$(".header-content").innerHeight()/2;n(),$(window).on("scroll resize",function(){n()}),$("a.ttext").click(function(n){function t(){window.open(""+e,"_blank")}n.preventDefault();var e=$(this).attr("href");setTimeout(function(){t()},500)}),$(".dot-block").click(function(n){n.preventDefault();var t=$(this),e=t.parents(".card");e.addClass("full")}),$(".close-card").click(function(n){n.preventDefault();var t=$(this),e=t.parents(".card");e.removeClass("full")}),$("#click-button").click(function(n){n.preventDefault(),t(".works")}),$(".bbutton-portfolio").click(function(n){n.preventDefault(),setTimeout(function(){$("body,html").addClass("stop-scroll"),$(".contact-from").addClass("active"),setTimeout(function(){$(".form-main").addClass("fadeIn")},300)},350)}),$(".close-link").click(function(n){n.preventDefault(),$(".form-main").removeClass("fadeIn"),setTimeout(function(){$(".contact-from").removeClass("active"),$("body,html").removeClass("stop-scroll")},350)});var o="input[type=text], input[type=password], input[type=email], input[type=url], input[type=tel], input[type=number], input[type=search], textarea";$(document).on("change",o,function(){(0!==$(this).val().length||void 0!==$(this).attr("placeholder"))&&($(this).siblings("label").addClass("active"),$(this).addClass("active"))}),Waves.init(),Waves.attach(".waves-dark",["waves-button"]),Waves.attach(".dot-block",["waves-button","waves-circle"]),Waves.attach(".ripple-circle",["waves-button","waves-circle"]),Waves.attach(".waves-light",["waves-button","waves-light"])});
