...
$(document).ready(function(){$(".inputFeed").keydown(function(e){""===$(this).val()?$(this).parent().removeClass("active"):$(this).parent().addClass("active"),console.log($(this).val())}),$("#fullpage").fullpage({easing:"easeInOutQuart",anchors:["firstPage","secondPage","thirdPage","fourthPage","lastPage"],menu:"#myMenu"}),$(".nextPage").click(function(e){e.preventDefault(),$.fn.fullpage.moveSectionDown()}),$("#tellModal").click(function(e){e.preventDefault(),$(".modal").addClass("active")}),$(".closeModalJS").click(function(e){e.preventDefault(),$(".modal").removeClass("active")})});
