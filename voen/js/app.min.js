...
$(document).ready(function(){
    $('.inputFeed,.textareaFeed').keydown(function(event) {
        if ($(this).val() === '') {
    ...
    // nav
    $('.nav').on('click', '.item-link', function(event) {
        event.preventDefault();
    ...
    $('#tellModal').click(function(event) {
        event.preventDefault();
        $('#otherModal').addClass('active')
    });
    $('.modalButton').click(function(event) {
    	event.preventDefault();
    	$('#servicesModal').addClass('active')
    });
    $('.closeModalJS').click(function(event) {
    	event.preventDefault();
    ...
    $('#nextOwl').click(function(event) {
        $('#owlCarousel').trigger('next.owl.carousel');
    });
    $('#prevOwl').click(function(event) {
        $('#owlCarousel').trigger('prev.owl.carousel');
    });
    // tab 
    $('.tab').first().addClass('activeTab');
    $('.tabs-nav').find('.list-item').eq(0).addClass('active');
    $('.tabs-nav').on('click', '.item-link', function(event) {
        event.preventDefault();
        var href = $(this).attr('href'),
            id = href.slice(1);
        $('.tab').removeClass('activeTab');
        $('.tabs-nav').find('.list-item').removeClass('active');
        $(this).parent().addClass('active');
        $('.tabs-content').find('#'+id).addClass('activeTab')
    });     
    ...
    $('.galleryItemImage').magnificPopup({
      type: 'image',
      gallery:{
        enabled:true
      }
    });
    $('.galleryItemVideo').magnificPopup({
      type: 'iframe',
      gallery:{
        enabled:true
      }
