...
$(document).ready(function(){$(".inputFeed,.textareaFeed").keydown(function(e){""===$(this).val()?$(this).parent().removeClass("active"):$(this).parent().addClass("active"),console.log($(this).val())}),$("#fullpage").fullpage({easing:"easeInOutQuart",onLeave:function(e,a,t){var l=$(".nav").find("li"),i=l.eq(a-1);l.removeClass("active"),i.addClass("active")}}),$(".nav").find("li").eq(0).addClass("active"),$(".nav").on("click",".item-link",function(e){e.preventDefault();var a=$(this).attr("data-id");$.fn.fullpage.moveTo(a)}),$(".nextPage").click(function(e){e.preventDefault(),$.fn.fullpage.moveSectionDown()}),$("#tellModal,.modalButton").click(function(e){e.preventDefault(),$("#otherModal").addClass("active")}),$(".closeModalJS").click(function(e){e.preventDefault(),$(this).parents(".modal").removeClass("active")}),$("#owlCarousel").owlCarousel({items:5}),$("#nextOwl").click(function(e){$("#owlCarousel").trigger("next.owl.carousel")}),$("#prevOwl").click(function(e){$("#owlCarousel").trigger("prev.owl.carousel")}),$(".tab").first().addClass("activeTab"),$(".tabs-nav").find(".list-item").eq(0).addClass("active"),$(".tabs-nav").on("click",".item-link",function(e){e.preventDefault();var a=$(this).attr("href"),t=a.slice(1);$(".tab").removeClass("activeTab"),$(".tabs-nav").find(".list-item").removeClass("active"),$(this).parent().addClass("active"),$(".tabs-content").find("#"+t).addClass("activeTab")}),$("#scrollNice").mCustomScrollbar({mouseWheel:!0}),$("#galleryScroll").mCustomScrollbar({mouseWheel:!0})});
